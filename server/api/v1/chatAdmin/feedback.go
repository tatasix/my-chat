...
var feedbackService = service.ServiceGroupApp.ClientGroup.FeedbackService
...
// @accept application/json
// @Produce application/json
// @Param data body chatAdmin.Feedback true "删除Feedback"
...
// @accept application/json
// @Produce application/json
// @Param data body chatAdmin.Feedback true "更新Feedback"
...
// @accept application/json
// @Produce application/json
// @Param data query chatAdmin.Feedback true "用id查询Feedback"
...
// @accept application/json
// @Produce application/json
// @Param data query chatAdminReq.FeedbackSearch true "分页获取Feedback列表"
// @Success 200 {string} string "{"success":true,"data":{},"msg":"获取成功"}"
// @Router /feedback/getFeedbackList [get]
func (feedbackApi *FeedbackApi) GetFeedbackList(c *gin.Context) {
	var pageInfo chatAdminReq.FeedbackSearch
